 ...
 * 2023-04-09T17:51:29.427+03:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:/C:/Devel/java_pft/soap-sample/src/main/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Devel/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Devel/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
